    ...
    content: {
      ...
      measurements: [
        {
          ...
          name: 'organoids_D0',
          type: 'feature',
          datasourceId: 'organoids_D0',
          datasourceGroup: 'organoids_D0',
          dataprovider: epiviz.Config.DEFAULT_DATA_PROVIDER_ID,
          formula: null,
          defaultChartType: 'Lines Track',
          annotation: null,
          minValue: null,
          maxValue: null,
          metadata: []
        },
        {
          ...
          name: 'organoids_D10',
          type: 'feature',
          datasourceId: 'organoids_D10',
          datasourceGroup: 'organoids_D10',
          dataprovider: epiviz.Config.DEFAULT_DATA_PROVIDER_ID,
          formula: null,
          defaultChartType: 'Lines Track',
          annotation: null,
        ...
        },
        {
          ...
          name: 'organoids_D2',
          type: 'feature',
          datasourceId: 'organoids_D2',
          datasourceGroup: 'organoids_D2',
          dataprovider: epiviz.Config.DEFAULT_DATA_PROVIDER_ID,
          formula: null,
          defaultChartType: 'Lines Track',
          annotation: null,
      ...
      charts: {
        track: [
          {
            id: 'track-initial',
            type: 'epiviz.plugins.charts.MultiStackedLineTrack',
            properties: { 
              width: 837, height: 120,
              margins: { top: 25, left: 20, bottom: 23, right: 10 },
              measurements: [0, 1, 2],
              colors: { id: 'd3-category10' },
              customSettings: {}
            }
          }
        ],
